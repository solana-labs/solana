...
case $TAG in
edge|beta)
  DOWNLOAD_URL=https://release.safecoin.org/"$TAG"/safecoin-release-$TARGET.tar.bz2
  ;;
*)
  DOWNLOAD_URL=https://github.com/solana-labs/safecoin/releases/download/"$TAG"/safecoin-release-$TARGET.tar.bz2
  ;;
esac
