...
pub const VALIDATOR_INFOS: &[ValidatorInfo] = &[
    ...
    ValidatorInfo {
        name: "Reserves",
        node: "PbAxyqHHPMwgEjv8kmjGxysk9rhNtN7q22eAjReq6Hj", // Placeholder
        vote: "PBAxyqHHPMwgEjv8kmjGxysk9rhNtN7q22eAjReq6Hj", // Placeholder
        node_sol: 43.0 * 500.0,
        commission: 0,
    },
];
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        ...
        let bootstrap_leader_stake = 0; // TODO: This should be non-zero and come from a pool.
        let rent_fees = 20; // TODO: Need a place to pay rent from.
        assert_eq!(
            lamports,
            500_000_000_000_000_000 - bootstrap_leader_stake + rent_fees,
            "{}",
            500_000_000 - lamports / 1_000_000_000
        );
        assert!(
            lamports <= 500_000_000_000_000_000 - bootstrap_leader_stake + rent_fees,
            "{} > 500,000,000",
