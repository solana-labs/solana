...
impl AccountsDbReplServerFactory {
    pub fn build_accountsdb_repl_server(confirmed_bank_receiver: Receiver<Slot>) -> AccountsDbReplServer {
        AccountsDbReplServer::new(
            Arc::new(RwLock::new(ReplicaUpdatedSlotsServerImpl::new(confirmed_bank_receiver))),
