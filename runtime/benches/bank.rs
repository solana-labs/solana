...
use log::*;
use safecoin_runtime::{bank::*, bank_client::BankClient, loader_utils::create_invoke_instruction};
use safecoin_sdk::{
    client::AsyncClient,
    client::SyncClient,
...
fn do_bench_transactions(
    ...
    bank.add_native_program("safecoin_noop_program", &Pubkey::new(&NOOP_PROGRAM_ID), false);
