...
pub struct AccountsDb {
    ...
    pub read_only_caching_enabled: bool,
...
impl Default for AccountsDb {
    fn default() -> Self {
        ...
        AccountsDb {
            ...
            read_only_caching_enabled: false,
            #[cfg(test)]
...
impl AccountsDb {
    ...
    pub fn new_with_config(
        ...
        read_only_caching_enabled: bool,
    ) -> Self {
    ...
    fn do_load(
        ...
        if self.read_only_caching_enabled
        ...
        if self.read_only_caching_enabled && self.caching_enabled && !is_cached {
            /*
...
pub mod tests {
    ...
    fn test_read_only_accounts_cache() {
        ...
        let read_only_caching_enabled = true;
