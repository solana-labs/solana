...
pub(crate) mod tests {
    ...
    #[test]
    fn test_clean_unrooted_dropped_frozen_banks() {
        //! Test that unrooted banks are cleaned up properly
        //!
        //! slot 0:       bank0 (rooted)
        //!               /   \
        //! slot 1:      /   bank1 (unrooted, dropped, and frozen)
        //!             /
        //! slot 2:  bank2 (rooted)
        //!
    ...
    #[test]
    fn test_clean_unrooted_dropped_unfrozen_banks() {
        //! Test that unrooted banks are cleaned up properly
        //!
        //! slot 0:       bank0 (rooted)
        //!               /   \
        //! slot 1:      /   bank1 (unrooted, dropped, and unfrozen)
        //!             /
        //! slot 2:  bank2 (rooted)
        //!
        //! In the scenario above, when `clean_accounts()` is called on bank2, the keys that exist
