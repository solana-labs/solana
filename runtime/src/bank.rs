...
pub(crate) mod tests {
    ...
    #[test]
    fn test_simpler_capitalization_adjustment_minimum_genesis_set() {
        solana_logger::setup();
    ...
    #[test]
    fn test_simpler_capitalization_adjustment_full_set() {
        solana_logger::setup();
        ...
        genesis_config
            .accounts
            .remove(&feature_set::simpler_capitalization::id());
