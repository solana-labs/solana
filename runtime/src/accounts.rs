    ...
    fn load_transaction(
        ...
        if tx.signatures().is_empty() && fee != 0 {
            ...
            let set_exempt_rent_epoch_max =
                feature_set.is_active(&solana_sdk::feature_set::remove_native_loader::id());
...
mod tests {
    ...
    fn test_load_accounts_fee_payer_is_nonce() {
        ...
        let loaded_accounts = load_accounts_with_fee_and_rent(
            ...
            &all_features_except(Some(&[
                solana_sdk::feature_set::remove_native_loader::id(),
            ])),
            &FeeStructure::default(),
        );
        assert_eq!(loaded_accounts.len(), 1);
    ...
    fn test_load_accounts_no_loaders() {
        ...
        let loaded_accounts = load_accounts_with_excluded_features(
            ...
            &accounts,
            &mut error_counters,
            Some(&[solana_sdk::feature_set::remove_native_loader::id()]),
        );
