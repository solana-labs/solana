...
mod tests {
    ...
    fn test_account_ids_after_program_ids() {
        ...
        bank.add_instruction_processor(solana_vote_program::id(), mock_ok_vote_processor);
        let result = bank.process_transaction(&tx);
        assert_eq!(result, Ok(()));
    ...
    fn test_fuzz_instructions() {
        ...
        let program_keys: Vec<_> = (0..max_programs)
            ...
            .map(|i| {
                ...
                bank.add_instruction_processor(key, mock_ok_vote_processor);
