...
fn test_bank_update_vote_stake_rewards() {
    ...
    check_bank_update_vote_stake_rewards(|bank: &Bank| {
        bank.load_vote_and_stake_accounts_impl_with_thread_pool(&thread_pool, null_tracer())
    });
    check_bank_update_vote_stake_rewards(|bank: &Bank| {
        bank.load_vote_and_stake_accounts_impl(&thread_pool, null_tracer())
    });
}
#[cfg(test)]
...
fn test_stake_vote_account_validity() {
    ...
    check_stake_vote_account_validity(
        ...
        |bank: &Bank| bank.load_vote_and_stake_accounts_impl(&thread_pool, null_tracer()),
    );
}
