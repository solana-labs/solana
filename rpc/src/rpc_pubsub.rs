...
pub trait RpcSolPubSub {
    ...
    // Subscribe to transactions in new slots
    #[pubsub(
        subscription = "slotTransactionsNotification",
        subscribe,
        name = "slotTransactionsSubscribe"
    )]
    fn slot_transactions_subscribe(
        &self,
        meta: Self::Metadata,
        subscriber: Subscriber<Arc<RpcSlotTransactionsUpdate>>,
        params: RpcSlotTransactionsParams,
    );

    // Unsubscribe from slot transactions notification subscription.
    #[pubsub(
        subscription = "slotTransactionsNotification",
        unsubscribe,
        name = "slotTransactionsUnsubscribe"
    )]
    fn slot_transactions_unsubscribe(
        &self,
        meta: Option<Self::Metadata>,
        id: PubSubSubscriptionId,
    ) -> Result<bool>;
...
mod internal {
    ...
    pub trait RpcSolPubSubInternal {
        ...
        // Subscribe to contents of slot
        fn slot_transactions_subscribe(
            &self,
            params: RpcSlotTransactionsParams,
        ) -> Result<SubscriptionId>;

        // Unsubscribe from slot contents notification subscription.
        fn slot_transactions_unsubscribe(&self, id: SubscriptionId) -> Result<bool>;
...
impl RpcSolPubSubInternal for RpcSolPubSubImpl {
    ...
    fn slot_transactions_subscribe(
        ...
        self.subscribe(SubscriptionParams::SlotTransactions(params))
    }
