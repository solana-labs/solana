...
fn do_test_optimistic_confirmation_violation_with_or_without_tower(with_tower: bool) {
    solana_logger::setup_with("error,quinn_proto=trace,quinn=trace,solana_quic_client=trace,solana_streamer::nonblocking::quic=trace,tokio=trace,streamer::quic=trace");
