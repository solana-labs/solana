...
testx:
	/usr/local/opt/llvm/bin/clang -c -Werror -target x86_64 -fno-builtin -fPIC  -o out/test.o src/test.c
	/usr/local/opt/llvm/bin/ld.lld -shared --Bdynamic out/test.o -o out/test.so

testbpf:
	/usr/local/opt/llvm/bin/clang -c -Werror -target bpf -fno-builtin -fPIC  -o out/bpf.o src/test.c

testbpfld:
	/usr/local/opt/llvm/bin/ld.lld -z notext -shared --Bdynamic out/bpf.o -o out/bpf.so