use {
    ...
    solana_sdk::{
        ...
        signature::Signer, transaction::Transaction, program_error::ProgramError,
    },
    std::str::FromStr,
};
...
async fn test_cpi_budgeted_early_termination() {
    ...
    let transaction = Transaction::new_signed_with_payer(
        &[Instruction::new_with_bincode(
            program_id,
            &[0],
            vec![AccountMeta::new_readonly(program_id_error, false), AccountMeta::new_readonly(program_id_inner, false)],
        )],
