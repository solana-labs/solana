...
```bash
$ export SOLANA_RELEASE=v0.16.2  # skip this line to install the latest release
$ curl -sSf https://raw.githubusercontent.com/solana-labs/solana/v0.16.2/install/solana-install-init.sh | sh -s
```
