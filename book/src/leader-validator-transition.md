...
let main(forks: Forks, leader_scheduler: LeaderScheduler, ncp: Ncp) {
    ...
    loop {
        ...
        // generator
        let validator = Validator::new(forks, leader_scheduler, generator, ncp);
        ...
        let recorder = PohRecorder::new(poh_entries, my_slot.end, bank_state,
            exit_signal);
        let leader = Leader::new(bank_state, recorder, ncp);
        exit_receiver.recv();
        leader.exit();
