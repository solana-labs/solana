...
impl ClusterInfo {
    ...
    fn new_pull_requests(&self, stakes: &HashMap<Pubkey, u64>) -> Vec<(SocketAddr, Protocol)> {
        ...
        let mut pulls: Vec<_> = {
            ...
            let reqs = r_gossip.new_pull_request(now, stakes, MAX_BLOOM_SIZE).ok();
        ...
        Builder::new()
            ...
            .spawn(move || {
                ...
                loop {
                    ...
                    let _ = Self::run_gossip(&obj, &recycler, &stakes, &sender, generate_pull_requests);
    ...
    fn print_reset_stats(&self, last_print: &mut Instant) {
        if last_print.elapsed().as_millis() > 1000 {
            ...
            datapoint_info!(
                ...
                (
                    "new_pull_requests_num",
                    self.stats.new_pull_requests_num.clear(),
                    i64
                ),
                (
                    "new_pull_requests2",
