...
impl ForkChoice for HeaviestSubtreeForkChoice {
    ...
    fn select_forks(
        ...
        let heaviest_slot_on_same_voted_fork = last_voted_slot
            .map(|last_voted_slot| {
                let heaviest_slot_on_same_voted_fork =
                    self.best_slot(last_voted_slot).unwrap_or_default();
                if heaviest_slot_on_same_voted_fork == 0 {
                    error!("fix me.....");
                    None
                } else if heaviest_slot_on_same_voted_fork == last_voted_slot {
                    None
                } else {
