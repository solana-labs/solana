...
impl RetransmitStats {
    fn maybe_submit(
        ...
        datapoint_info!(
            ...
            (
                "batch_span_us_50pct",
                stats.batch_span_us_hist.percentile(50.0).unwrap_or(0),
                i64
            ),
            (
                "batch_span_us_90pct",
                stats.batch_span_us_hist.percentile(90.0).unwrap_or(0),
                i64
            ),
            (
                "batch_span_us_min",
                stats.batch_span_us_hist.minimum().unwrap_or(0),
                i64
            ),
            (
                "batch_span_us_max",
                stats.batch_span_us_hist.maximum().unwrap_or(0),
                i64
            ),
            (
                "batch_span_us_mean",
                stats.batch_span_us_hist.mean().unwrap_or(0),
                i64
            ),
            (
                "batch_first_recv_us_50pct",
                stats.batch_first_recv_us_hist.percentile(50.0).unwrap_or(0),
                i64
            ),
            (
                "batch_first_recv_us_90pct",
                stats.batch_first_recv_us_hist.percentile(90.0).unwrap_or(0),
                i64
            ),
            (
                "batch_first_recv_us_min",
                stats.batch_first_recv_us_hist.minimum().unwrap_or(0),
                i64
            ),
            (
                "batch_first_recv_us_max",
                stats.batch_first_recv_us_hist.maximum().unwrap_or(0),
                i64
            ),
            (
                "batch_first_recv_us_mean",
                stats.batch_first_recv_us_hist.mean().unwrap_or(0),
                i64
            ),
        );
    }
...
fn retransmit(
    ...
    cluster_info: &ClusterInfo,
    shreds_receiver: &ShredsReceiver,
    sockets: &[UdpSocket],
    ...
    stats
        ...
        .increment((Instant::now() - shreds_incoming_start_time).as_micros() as u64)
        .unwrap();
    stats
        .batch_span_us_hist
