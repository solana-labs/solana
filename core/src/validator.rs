...
use {
    crate::{
        ...
        tpu::{Tpu, TpuSockets, DEFAULT_TPU_COALESCE_MS, DEFAULT_TPU_MAX_QUEUED_BATCHES},
...
pub struct ValidatorConfig {
    ...
    pub tpu_max_queued_batches: usize,
...
impl Default for ValidatorConfig {
    fn default() -> Self {
        Self {
            ...
            tpu_max_queued_batches: DEFAULT_TPU_MAX_QUEUED_BATCHES,
