...
use {
    crate::{
        ...
        tpu::{Tpu, TpuSockets, DEFAULT_TPU_COALESCE_MS, DEFAULT_TPU_MAX_QUEUED_BATCHES_UDP},
...
pub struct ValidatorConfig {
    ...
    pub tpu_max_queued_batches_udp: usize,
...
impl Default for ValidatorConfig {
    fn default() -> Self {
        Self {
            ...
            tpu_max_queued_batches_udp: DEFAULT_TPU_MAX_QUEUED_BATCHES_UDP,
    ...
    pub fn new(
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        let tpu = Tpu::new(
            ...
            config.tpu_max_queued_batches_udp,
