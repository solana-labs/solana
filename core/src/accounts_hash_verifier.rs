...
impl AccountsHashVerifier {
    ...
    fn calculate_and_verify_accounts_hash(accounts_package: &AccountsPackage) -> AccountsHashEnum {
        ...
        let (
            ...
            CalcAccountsHashFlavor::Incremental => {
                ...
                let (incremental_accounts_hash, capitalization) =
                ...
                let bank_incremental_snapshot_persistence = BankIncrementalSnapshotPersistence {
                    ...
                    incremental_capitalization: capitalization,
                };
                (
                    incremental_accounts_hash.into(),
                    // Once reconstructing accounts db in serde_snapshot is made aware of
                    // incremental accounts hashes then this value won't matter.
                    AccountsHash(incremental_accounts_hash.0),
    ...
    fn _calculate_full_accounts_hash(
        ...
        let ((accounts_hash, lamports), measure_hash_us) = measure_us!(
            accounts_package
                .accounts
                .accounts_db
    ...
    fn _calculate_incremental_accounts_hash(
        ...
        let old_incremental_accounts_hash = accounts_package
            .accounts
            .accounts_db
            .set_incremental_accounts_hash(slot, incremental_accounts_hash);
