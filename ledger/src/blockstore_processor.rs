...
fn execute_batch(
    ...
    */
    ...
    bank.schedule_and_commit_transactions_as_replaying(transactions, transaction_indexes);
    /*
...
fn process_bank_0(
    ...
    bank0.wait_for_scheduler(false, false).0.unwrap();
    bank0.freeze();
    if blockstore.is_primary_access() {
...
fn process_single_slot(
    ...
    bank.wait_for_scheduler(false, false).0?;
