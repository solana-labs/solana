...
mod utils {
    ...
    ///
    /// Further more, it's still allowed to create _multiple_ tokens in a _single_ process as long
    /// as no instance of [`TokenCell`] is shared by multiple instances of [`Token`].
    ///
