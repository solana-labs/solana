...
impl Checkpoint {
    pub fn wait_for_restart(&self) {
        ...
        let ((threads_before_checkpoint, threads_after_checkpoint), self_return_value, _a, context_count) = &mut *g;
        info!(
        ...
        *threads_before_checkpoint = threads_before_checkpoint.checked_sub(1).unwrap();
        ...
        if *threads_before_checkpoint == 0 {
            ...
            *threads_after_checkpoint = threads_after_checkpoint.checked_add(1).unwrap();
            ...
            drop((threads_before_checkpoint, threads_after_checkpoint, self_return_value, _a, context_count, g));
            self.1.notify_all();
            info!(
