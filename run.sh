...
if [[ -e $leader_keypair ]]; then
  ...
  solana-keygen new -nso "$leader_keypair"
fi
...
if [[ -e $leader_vote_account_keypair ]]; then
  ...
  solana-keygen new -nso "$leader_vote_account_keypair"
fi
...
if [[ -e $leader_storage_account_keypair ]]; then
  ...
  solana-keygen new -fnso "$leader_storage_account_keypair"
fi
