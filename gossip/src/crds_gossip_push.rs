...
mod test {
    ...
    fn test_prune() {
        ...
        let value = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(
    ...
    fn test_process_push_old_version() {
        ...
        ci.wallclock = 1;
        let value = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ci.clone())));
        ...
        // push an old version
        ci.wallclock = 0;
        let value = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ci)));
        assert_eq!(
            push.process_push_message(&crds, &Pubkey::default(), vec![value], 0),
            [Err(CrdsGossipError::PushMessageOldVersion)],
        );
    ...
    fn test_process_push_update() {
        ...
        let origin = ci.id;
        ci.wallclock = 0;
        let value_old = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ci.clone())));
    ...
    fn test_refresh_active_set() {
        ...
        let push = CrdsGossipPush::default();
        let value1 = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(
            ContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0),
        )));
        ...
        let value2 = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(
            ContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0),
        )));
    ...
    fn test_active_set_refresh_with_bank() {
        ...
        let mut stakes = HashMap::new();
        for i in 1..=100 {
            let peer = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(
    ...
    fn test_no_pushes_to_from_different_shred_versions() {
        ...
        let me = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 123,
            gossip,
            ..ContactInfo::default()
        })));
        let spy = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 0,
            gossip,
            ..ContactInfo::default()
        })));
        let node_123 = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 123,
            gossip,
            ..ContactInfo::default()
        })));
        let node_456 = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ContactInfo {
            id: solana_sdk::pubkey::new_rand(),
            shred_version: 456,
            gossip,
            ..ContactInfo::default()
    ...
    fn test_new_push_messages() {
        ...
        let new_msg = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(
            ContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0),
        )));
    ...
    fn test_personalized_push_messages() {
        ...
        let peers: Vec<_> = vec![0, 0, now]
            ...
            .map(|wallclock| {
                ...
                CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(peer)))
            })
            .collect();
    ...
    fn test_purge_old_pending_push_messages() {
        ...
        let mut ci = ContactInfo::new_localhost(&solana_sdk::pubkey::new_rand(), 0);
        ci.wallclock = 1;
        let new_msg = CrdsValue::new_unsigned(CrdsData::ContactInfo(Box::new(ci)));
        let expected = HashMap::new();
        let origin = new_msg.pubkey();
        assert_eq!(
