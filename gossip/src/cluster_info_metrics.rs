...
pub(crate) fn submit_gossip_stats(
    ...
    datapoint_info!(
        ...
        ("RestartLastVotedForkSlots-push", crds_stats.push.counts[12], i64),
        ("RestartLastVotedForkSlots-pull", crds_stats.pull.counts[12], i64),
    ...
    datapoint_info!(
        ...
        ("RestartLastVotedForkSlots-push", crds_stats.push.fails[12], i64),
        ("RestartLastVotedForkSlots-pull", crds_stats.pull.fails[12], i64),
