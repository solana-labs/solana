...
pub struct GossipStats {
    ...
    pub(crate) get_duplicate_shreds: Counter,
    pub(crate) get_duplicate_shreds_count: Counter,
...
pub(crate) fn submit_gossip_stats(
    ...
    datapoint_info!(
        ...
        (
            "get_duplicate_shreds",
            stats.get_duplicate_shreds.clear(),
            i64
        ),
        (
            "get_duplicate_shreds_count",
            stats.get_duplicate_shreds_count.clear(),
            i64
        ),
