...
pub struct GossipStats {
    ...
    pub(crate) get_entries: Counter,
    pub(crate) get_entries_count: Counter,
...
pub(crate) fn submit_gossip_stats(
    ...
    datapoint_info!(
        ...
        ("get_entries", stats.get_entries.clear(), i64),
        ("get_entries_count", stats.get_entries_count.clear(), i64),
