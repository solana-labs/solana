...
### Update the public book
Run a new build of the following buildkite pipeline.  In Environment Variables, set:
```bash
PUBLISH_BOOK_TAG=[tag of the recently released build]
```
for example:
```bash
PUBLISH_BOOK_TAG=v0.16.4
```
