...
pub const QUIC_TOTAL_STAKED_CONCURRENT_STREAMS: usize = 1_000_000;

// Set the maximum concurrent stream numbers to avoid excessive streams
pub const QUIC_MAX_STAKED_CONCURRENT_STREAMS: usize = 20480;
...
pub const QUIC_UNSTAKED_RECEIVE_WINDOW_RATIO: u64 = 10;
...
/// set to this ratio times [`solana_sdk::packet::PACKET_DATA_SIZE`]
pub const QUIC_MAX_STAKED_RECEIVE_WINDOW_RATIO: u64 = 100;
