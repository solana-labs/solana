...
const INVALID_ARGUMENT: u32 = BUILTIN_ERROR_START + 1;
const INVALID_INSTRUCTION_DATA: u32 = BUILTIN_ERROR_START + 2;
const INVALID_ACCOUNT_DATA: u32 = BUILTIN_ERROR_START + 3;
const ACCOUNT_DATA_TOO_SMALL: u32 = BUILTIN_ERROR_START + 4;
const INSUFFICIENT_FUNDS: u32 = BUILTIN_ERROR_START + 5;
const INCORRECT_PROGRAM_ID: u32 = BUILTIN_ERROR_START + 6;
const MISSING_REQUIRED_SIGNATURES: u32 = BUILTIN_ERROR_START + 7;
const ACCOUNT_ALREADY_INITIALIZED: u32 = BUILTIN_ERROR_START + 8;
const UNINITIALIZED_ACCOUNT: u32 = BUILTIN_ERROR_START + 9;
