...
pub mod stake_raise_minimum_delegation_to_100m_lamports {
    // This is a feature-proposal *feature id*.  The feature keypair address is `EVh5WdHoEvDfrW18CiH2emVYpxjMd2tMRnaT8yXC5oCu`.
    solana_sdk::declare_id!("3Ynd8eXcJQVc79V75dH1Ut4JR5taoRG7j4oYJKQUpaGd");
}
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (stake_raise_minimum_delegation_to_100m_lamports::id(), "Raise minimum stake delegation to 0.1 SOL #27366"),
