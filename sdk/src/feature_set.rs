...
pub mod spl_associated_token_account_v1_0_4_release {
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (spl_associated_token_account_v1_0_4_release::id(), "SPL Associated Token Account Program release version 1.0.4, tied to token 3.3.0 #22648"),
