...
pub mod rent_exempt_accounts_ignore_rent_epoch {
    // todo - use real key here
    solana_sdk::declare_id!("Ff8b1fBeB86q8cjq47ZhsQLgv5EkHu3G1C99zjUfAzrr");
}
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (rent_exempt_accounts_ignore_rent_epoch::id(), "rent exempt accounts ignore rent epoch"),
