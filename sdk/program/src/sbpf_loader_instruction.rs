...
pub enum SbfLoaderInstruction {
    ...
    /// rent excemption are transferred, in case that the source was bigger than the program.
    ///
    /// # Account references
    ...
    ///
    /// WARNING: Not providing a new authority finalizes the program (it becomes immutable).
    ///
    /// # Account references
