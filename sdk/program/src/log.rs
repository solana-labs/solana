...
macro_rules! msg {
    ...
    ($($arg:tt)*) => ($crate::log::safe_log(&format!($($arg)*)));
}
...
pub fn safe_log(message: &str) {
    #[cfg(target_arch = "bpf")]
    unsafe {
        safe_log_(message.as_ptr(), message.len() as u64);
    }

    #[cfg(not(target_arch = "bpf"))]
    crate::program_stubs::safe_log(message);
}

#[cfg(target_arch = "bpf")]
extern "C" {
    fn safe_log_(message: *const u8, len: u64);
}
...
#[inline]
pub fn safe_log_64(arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
    #[cfg(target_arch = "bpf")]
    unsafe {
        safe_log_64_(arg1, arg2, arg3, arg4, arg5);
    }

    #[cfg(not(target_arch = "bpf"))]
    crate::program_stubs::safe_log_64(arg1, arg2, arg3, arg4, arg5);
}

#[cfg(target_arch = "bpf")]
extern "C" {
    fn safe_log_64_(arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64);
}
...
#[allow(dead_code)]
pub fn safe_log_slice(slice: &[u8]) {
...
#[allow(dead_code)]
pub fn safe_log_params(accounts: &[AccountInfo], data: &[u8]) {
...
#[inline]
pub fn safe_log_compute_units() {
    #[cfg(target_arch = "bpf")]
    unsafe {
        safe_log_compute_units_();
    }
    #[cfg(not(target_arch = "bpf"))]
    crate::program_stubs::safe_log_compute_units();
}

#[cfg(target_arch = "bpf")]
extern "C" {
    fn safe_log_compute_units_();
}
