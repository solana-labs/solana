...
define_syscall!(fn sol_alt_bn128_addition(input: *const u8, input_size: u64, result: *mut u8) -> u64);
define_syscall!(fn sol_alt_bn128_multiplication(input: *const u8, input_size: u64, result: *mut u8) -> u64);
define_syscall!(fn sol_alt_bn128_pairing(input: *const u8, input_size: u64, result: *mut u8) -> u64);
