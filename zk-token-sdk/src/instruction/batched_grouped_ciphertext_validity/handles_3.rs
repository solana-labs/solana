...
impl BatchedGroupedCiphertext3HandlesValidityProofData {
    pub fn new(
        ...
        let pod_source_pubkey = pod::ElGamalPubkey(source_pubkey.to_bytes());
    ...
    for BatchedGroupedCiphertext3HandlesValidityProofData
{
    ...
    fn verify_proof(&self) -> Result<(), ProofError> {
        ...
        let source_handle_lo = grouped_ciphertext_lo.handles.get(0).unwrap();
        ...
        let source_handle_hi = grouped_ciphertext_hi.handles.get(0).unwrap();
