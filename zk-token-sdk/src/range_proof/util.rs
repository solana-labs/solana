...
impl VecPoly1 {
    pub fn zero(n: usize) -> Self {
        VecPoly1(vec![*SCALAR_ZERO; n], vec![*SCALAR_ZERO; n])
    }
...
pub fn add_vec(a: &[Scalar], b: &[Scalar]) -> Vec<Scalar> {
    ...
    let mut out = vec![*SCALAR_ZERO; b.len()];
    for i in 0..a.len() {
        out[i] = a[i] + b[i];
    }
    out
