//! An [`RpcSender`] and [`Async RpcSender`]used for unit testing [`RpcClient`](crate::rpc_client::RpcClient)
//! and [`AsyncRpcClient`](crate::rpc_client::AsyncRpcClient).
...
pub struct MockAsyncSender {
    mocks: RwLock<Mocks>,
    url: String,
}

/// An [`AsyncRpcSender`] used for unit testing [`AsyncRpcClient`](crate::rpc_client::AsyncRpcClient).
///
/// This is primarily for internal use.
///
/// Unless directed otherwise, it will generally return a reasonable default
...
#[async_trait]
impl AsyncRpcSender for MockAsyncSender {
    fn get_transport_stats(&self) -> RpcTransportStats {
        RpcTransportStats::default()
    }
