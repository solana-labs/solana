...
fn test_stake_set_lockup() {
    ...
    config_offline.command = CliCommand::StakeSetLockup {
        ...
        custodian: 0,
        sign_only: true,
        blockhash_query: BlockhashQuery::new(Some(nonce_hash), true, Some(nonce_account_pubkey)),
    ...
    config.command = CliCommand::StakeSetLockup {
        ...
        custodian: 0,
        sign_only: false,
        blockhash_query: BlockhashQuery::new(Some(blockhash), false, Some(nonce_account_pubkey)),
        nonce_account: Some(nonce_account_pubkey),
        nonce_authority: 0,
        fee_payer: 0,
    };
...
fn test_offline_nonced_create_stake_account_and_withdraw() {
    ...
    config_offline.command = CliCommand::CreateStakeAccount {
        ...
        lamports: 50_000,
        sign_only: true,
        blockhash_query: BlockhashQuery::new(Some(nonce_hash), true, Some(nonce_pubkey)),
    ...
    config.command = CliCommand::CreateStakeAccount {
        ...
        lamports: 50_000,
        sign_only: false,
        blockhash_query: BlockhashQuery::new(Some(blockhash), false, Some(nonce_pubkey)),
        nonce_account: Some(nonce_pubkey),
        nonce_authority: 0,
        fee_payer: 0,
        from: 0,
