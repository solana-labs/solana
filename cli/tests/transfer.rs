...
fn test_transfer() {
    ...
    offline.command = CliCommand::Transfer {
        ...
        from: 0,
        sign_only: true,
        blockhash_query: BlockhashQuery::new(Some(nonce_hash), true, Some(nonce_account.pubkey())),
        nonce_account: Some(nonce_account.pubkey()),
        nonce_authority: 0,
        fee_payer: 0,
    };
    ...
    config.command = CliCommand::Transfer {
        ...
        from: 0,
        sign_only: false,
        blockhash_query: BlockhashQuery::new(Some(blockhash), false, Some(nonce_account.pubkey())),
        nonce_account: Some(nonce_account.pubkey()),
        nonce_authority: 0,
        fee_payer: 0,
    };
