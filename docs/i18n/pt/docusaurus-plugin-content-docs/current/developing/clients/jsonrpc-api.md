...
- `<string>` - (opcional) codificação para a transação retornada, ou "json", "jsonParsed", "base58" (_slow_), ou "base64". Se o parâmetro não for fornecido, a codificação padrão é JSON.
