...
So we see that the _Adjusted Staked Yield_ a function of the inflation rate and the percent of staked tokens on the network. 様々なステーキングの分数についてプロットされています:
