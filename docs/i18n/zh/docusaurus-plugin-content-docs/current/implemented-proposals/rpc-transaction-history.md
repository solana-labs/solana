...
需要注意的是，不支持[getBlockTime](developing/clients/jsonrpc-api.md#getblocktime)，因为一旦https://github.com/Safecoin-labs/Safecoin/issues/10089 被修复，那么`getBlockTime`就可以被删除。
