...
Транзакция прошла успешно! Боб получает на свой счёт 0.01 SOL, а хранимое значение nonce в одноразовом аккаунте, пренадлежащего Алисе, обновляется и готово для использования в следующей транзакции
