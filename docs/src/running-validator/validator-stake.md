...
Now delegate 1 SAND to your validator by first creating your stake account:
...
> Don’t delegate your remaining SAND, as your validator will use those tokens to vote.
