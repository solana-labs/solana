...
NAT traversal issues. A cloud-hosted machine works best. **Ensure that IP ports 8000 through 1.0.2 are not blocked for Internet inbound and outbound traffic.**
