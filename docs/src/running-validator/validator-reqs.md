...
## Minimum SAND requirements

There is no strict minimum amount of SAND required to run a validator on Solana.

However in order to participate in consensus, a vote account is required which
has a rent-exempt reserve of 0.02685864 SAND. Voting also requires sending a vote
