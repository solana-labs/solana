...
[create-vote-account](../cli/usage.md#safecoin-create-vote-account) command.
...
[vote-update-validator](../cli/usage.md#safecoin-vote-update-validator).
 - To change the [vote authority](#vote-authority), use
[vote-authorize-voter](../cli/usage.md#safecoin-vote-authorize-voter).
 - To change the [withdraw authority](#withdraw-authority), use
[vote-authorize-withdrawer](../cli/usage.md#safecoin-vote-authorize-withdrawer).
 - To change the [commission](#commission), use
 [vote-update-commission](../cli/usage.md#safecoin-vote-update-commission).
...
the [vote-update-validator](../cli/usage.md#safecoin-vote-update-validator) command.
...
[vote-authorize-voter](../cli/usage.md#safecoin-vote-authorize-voter) command.

The vote authority can be changed at most once per epoch.  If the authority is
changed with [vote-authorize-voter](../cli/usage.md#safecoin-vote-authorize-voter),
...
using the [withdraw-from-vote-account](../cli/usage.md#safecoin-withdraw-from-vote-account)
...
[vote-update-commission](../cli/usage.md#safecoin-vote-update-commission) command.
...
3. Determine the current _vote authority_ keypair by running `safecoin
