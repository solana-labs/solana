...
## Leader Replay With Consecutive Blocks {#leader-replay-with-consecutive-blocks}
...
## Reseting the Balance Cache {#reseting-the-balance-cache}
...
## Impact on Clients {#impact-on-clients}
