...
<details>
  ...
  <li>"base58" is limited to Account data of less than 129 bytes.</li>
  <li>
    "base64" will return base64 encoded data for Account data of any size.
  </li>
  <li>
    "base64+zstd" compresses the Account data using{" "}
    <a href="https://facebook.github.io/zstd/">Zstandard</a> and base64-encodes
    the result.
  </li>
  <li>
    <a href="#parsed-responses">"jsonParsed" encoding</a> attempts to use
