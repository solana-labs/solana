...
- `<array>` - (optional) An array of account address strings. If this parameter is provided, the response will reflect the minimum prioritization fee to land transaction locking any of the provided accounts as writable.
