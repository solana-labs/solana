...
title: Home
sidebar_label: Home
description: "The Solana blockchain is an open source project implementing a new, high-performance, permissionless blockchain."
# displayed_sidebar: introductionSidebar
---

# Solana Blockchain Documentaion

The Solana blockchain is an open source project implementing a new, high-performance, permissionless
blockchain. The Solana Foundation is based in Geneva, Switzerland and maintains the open source project.
