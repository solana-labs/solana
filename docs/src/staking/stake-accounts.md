...
receive SAND from other accounts on the network, whereas a stake account supports
...
balance of 0 SAND is no longer tracked. If a stake account is not delegated
