...
* [getRecentBlockhashLastValidSlot](jsonrpc-api.md#getrecentblockhashlastvalidslot)
...
```bash
// Request
curl -X POST -H "Content-Type: application/json" -d '{"jsonrpc":"2.0","id":1, "method":"getRecentBlockhashLastValidSlot"}' http://localhost:8899
