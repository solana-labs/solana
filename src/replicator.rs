...
impl Replicator {
    ...
    pub fn new(
        ...
        loop {
            ...
            storage_last_id =
                Rpu::make_rpc_request(&rpc_client, 2, RpcRequest::GetStorageMiningLastId, None)
                    .expect("rpc request")
                    .to_string();
            storage_entry_height = Rpu::make_rpc_request(
                &rpc_client,
                2,
                RpcRequest::GetStorageMiningEntryHeight,
                None,
            )
            .expect("rpc request")
            .as_u64()
