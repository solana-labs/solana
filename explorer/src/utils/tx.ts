...
export const PROGRAM_DEPLOYMENTS = {
  ...
  [PROGRAM_NAMES.QUARRY_MINE]: [Cluster.Devnet, Cluster.MainnetBeta] as Cluster[],
  [PROGRAM_NAMES.QUARRY_MINT_WRAPPER]: [Cluster.Devnet, Cluster.MainnetBeta] as Cluster[],
  [PROGRAM_NAMES.QUARRY_REGISTRY]: [Cluster.Devnet, Cluster.MainnetBeta] as Cluster[],
