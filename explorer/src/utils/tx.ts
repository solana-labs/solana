...
export enum PROGRAM_NAMES {
  ...
  SUNNY = "Sunny Yield Aggregator Program",
...
export const PROGRAM_DEPLOYMENTS = {
  ...
  [PROGRAM_NAMES.ORCA]: MAINNET_ONLY,
  ...
  [PROGRAM_NAMES.SABER_SWAP]: MAINNET_ONLY,
  ...
  [PROGRAM_NAMES.SUNNY]: MAINNET_ONLY,
...
export const PROGRAM_NAME_BY_ID = {
  ...
  Ez52BLSoZw3MxWxMK4ADsJXqzUiYW9sUnwcrrQwQGdLT: PROGRAM_NAMES.ORCA,
  ...
  Crt7UoUR6QgrFrN7j8rmSQpUTNWNSitSwWvsWGf1qZ5t: PROGRAM_NAMES.SUNNY,
