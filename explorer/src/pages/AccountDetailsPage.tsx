...
import { isFlaggedAccount } from "flaggedAccountsRegistry";
...
function DetailsSections({ pubkey, tab }: { pubkey: PublicKey; tab?: string }) {
  ...
  const isFlagged = isFlaggedAccount(address);
    ...
    <>
      {isFlagged && (
        <div className="alert alert-danger alert-scam" role="alert">
          Warning! This account has been flagged by the Solana community as a scam account. Please be
