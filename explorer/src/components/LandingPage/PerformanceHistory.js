...
export default class PerformanceHistory extends Component {
  constructor(props) {
    ...
    this.state = {
      RPCdata: {
        perfHistory: {
          series_s: [{ name: "TPS", data: [] }],
          series_m: [{ name: "TPS", data: [] }],
          series_l: [{ name: "TPS", data: [] }],
        },
  ...
  showMidHistory() {
    this.setState({
      showPerfHistory_short: false,
      showPerfHistory_mid: true,
      showPerfHistory_long: false,
    });
  }
  showLongHistory() {
  ...
  render() {
    ...
    const series_s_max = Math.max(
      ...this.state.RPCdata.perfHistory.series_s[0].data
    );
    const series_m_max = Math.max(
      ...this.state.RPCdata.perfHistory.series_m[0].data
    );
    const series_l_max = Math.max(
      ...this.state.RPCdata.perfHistory.series_l[0].data
    );
                    ...
                    <div className="font-weight-bold w-100">
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="font-size-sm">
                          <div>
                            <button
                              onClick={() => this.showShortHistory()}
                              className={
                                this.state.showPerfHistory_short
                                  ? "btn-active btn perf-history-btn mr-2"
                                  : "btn perf-history-btn mr-2"
                              }
                            >
                              30m
                            </button>
                            <button
                              onClick={() => this.showMidHistory()}
                              className={
                                this.state.showPerfHistory_mid
                                  ? "btn-active btn perf-history-btn mr-2"
                                  : "btn perf-history-btn mr-2"
                            ...
                            <button
                              onClick={() => this.showLongHistory()}
                              className={
                                this.state.showPerfHistory_long
                                  ? "btn-active btn perf-history-btn"
                                  : "btn perf-history-btn"
                              }
                            >
                              6h
                            </button>
                      ...
                      <div className="mt-2 d-flex justify-content-end flex-row w-100">
                        {this.state.showPerfHistory_short && (
                          <div className="position-relative y-axis">
                            <div className="max-tick">
                              <small>
                                {this.nFormatter(series_s_max / 15)}
                              </small>
                            </div>
                            <div className="middle-tick">
                              <small>
                                {this.nFormatter(series_s_max / 2 / 15)}
                              </small>
                            </div>
                          </div>
                        )}
                        ...
                        {this.state.showPerfHistory_mid && (
                          <div className="position-relative y-axis">
                            <div className="max-tick">
                              <small>
                                {this.nFormatter(series_m_max / 60)}
                              </small>
                            </div>
                            <div className="middle-tick">
                              <small>
                                {this.nFormatter(series_m_max / 2 / 60)}
                              </small>
                            </div>
                          </div>
                        )}
                        ...
                        {this.state.showPerfHistory_long && (
                          <div className="position-relative y-axis">
                            <div className="max-tick">
                              <small>
                                {this.nFormatter(series_l_max / 180)}
                              </small>
                            </div>
                            <div className="middle-tick">
                              <small>
                                {this.nFormatter(series_l_max / 2 / 180)}
                              </small>
                            </div>
                          </div>
                        )}
