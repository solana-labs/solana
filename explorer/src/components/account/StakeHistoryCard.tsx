          ...
          <table className="table table-sm table-nowrap card-table">
            <thead>
              <tr>
                ...
                <th className="text-muted">Effective (SAND)</th>
                <th className="text-muted">Activating (SAND)</th>
                <th className="text-muted">Deactivating (SAND)</th>
              </tr>
            </thead>
  ...
  return (
    <tr key={index}>
      ...
      <td className="font-monospace">
        <SandBalancelamports={entry.stakeHistory.effective} />
      </td>
      <td className="font-monospace">
        <SandBalancelamports={entry.stakeHistory.activating} />
      </td>
      <td className="font-monospace">
        <SandBalancelamports={entry.stakeHistory.deactivating} />
      </td>
    </tr>
  );
};
