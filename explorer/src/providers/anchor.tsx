...
import { Idl, Program, Provider, BorshAccountsCoder } from "@project-serum/anchor";
...
export function useAnchorAccount(
    ...
    if (cacheEntry === undefined) {
        let fetchPromise = (async () => {
            ...
            const accountInfo = await (new Connection(url)).getAccountInfo(new PublicKey(accountPubkey));
