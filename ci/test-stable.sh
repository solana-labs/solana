...
test-stable-perf)
  ...
  _ "$cargo" stable test --package solana-perf --package solana-ledger --package solana-core --lib ${V:+--verbose} -- sigverify_shreds::tests::test_sigverify_shreds_sign_gpu --nocapture
