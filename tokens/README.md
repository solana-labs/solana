...
Currently, this will subtract 1 SAND from each allocation and store it the
recipient address. That SAND can be used to pay transaction fees on staking
...
Distributing SPL Tokens works very similarly to distributing SAND, but requires
...
As with SAND, you can List the differences between a list of expected
