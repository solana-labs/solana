...
mod tests {
    use {
        crate::loaded_programs::{
            ...
            LoadedPrograms, ProgramRuntimeEnvironment, ProgramRuntimeEnvironments,
            DELAY_VISIBILITY_SLOT_OFFSET,
        },
    ...
    fn test_fork_extract_and_prune() {
        ...
        let extracted = cache.extract(22, &mut missing);
        ...
        let extracted = cache.extract(15, &mut missing);
        ...
        let extracted = cache.extract(18, &mut missing);
        ...
        let extracted = cache.extract(23, &mut missing);
        ...
        let extracted = cache.extract(11, &mut missing);
        ...
        let extracted = cache.extract(19, &mut missing);
        ...
        let extracted = cache.extract(21, &mut missing);
        ...
        let extracted = cache.extract(27, &mut missing);
    ...
    fn test_extract_using_deployment_slot() {
        ...
        let extracted = cache.extract(12, &mut missing);
    ...
    fn test_fork_prune_find_first_ancestor() {
        ...
        let extracted = cache.extract(20, &mut missing);
    ...
    fn test_prune_by_deployment_slot() {
        ...
        let extracted = cache.extract(6, &mut missing);
