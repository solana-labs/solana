...
impl ComputeBudget {
    pub fn new(compute_unit_limit: u64) -> Self {
        ComputeBudget {
            ...
            curve25519_edwards_msm_base_cost: 2_000, // TODO: update precise cost
            curve25519_edwards_msm_incremental_cost: 2000,
            ...
            curve25519_ristretto_msm_base_cost: 2_000, // TODO: update precise cost
            curve25519_ristretto_msm_incremental_cost: 2000,
            heap_size: None,
            heap_cost: 8,
            mem_op_base_cost: 10,
