...
pub struct ComputeBudget {
    ...
    pub curve25519_edwards_op_cost: u64,
    /// Number of compute units consumed to add/sub two ristretto points
    pub curve25519_ristretto_op_cost: u64,
    /// Number of compute units consumed to add/sub/mul/div two scalar points
    pub curve25519_scalar_op_cost: u64,
    /// Number of compute units consumed to do one edwards point-scalar multiplication
    pub curve25519_edwards_mul_cost: u64,
    /// Number of compute units consumed to do one ristretto point-scalar multiplication
    pub curve25519_ristretto_mul_cost: u64,
...
impl ComputeBudget {
    pub fn new(max_units: u32) -> Self {
        ComputeBudget {
            ...
            curve25519_edwards_op_cost: 25_000,
            curve25519_ristretto_op_cost: 25_000,
            curve25519_scalar_op_cost: 25_000,
            curve25519_edwards_mul_cost: 25_000,
            curve25519_ristretto_mul_cost: 25_000,
            heap_size: None,
            heap_cost: 8,
            mem_op_base_cost: 10,
        }
