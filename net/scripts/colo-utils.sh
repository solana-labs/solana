...
declare -r SAFECOIN_LOCK_FILE="/home/safecoin/.safecoin.lock"
...
SSH_AUTHORIZED_KEYS='$("${__colo_here}"/add-datacenter-safecoin-user-authorized_keys.sh 2> /dev/null)'
